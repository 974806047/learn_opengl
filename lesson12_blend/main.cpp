...
void testCase2() {
    ...
    GLBufferData windowBufferData = initGLBuffer(transparentVertices, 6 * 5, true);
    // 创建并使用程序对象
    ...
    unsigned int windowT = read_image("./image/window.png", GL_RGBA, GL_RGBA);
...
#pragma endregion
        ...
        glBindVertexArray(windowBufferData.VAO);
