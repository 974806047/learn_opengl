...
void testCase2() {
    ...
    GLBufferData objBufferData = initGLBuffer(vertices, 36 * 6, indices, 6, false);
    GLBufferData lightBufferData = initGLBuffer(vertices, 36 * 6, indices, 6, false);
    // 创建并使用程序对象
...
#pragma endregion
        ...
        // obj渲染
        objShader.use();
        objShader.setFloat("time", (sin(time) + 1) / 2);
